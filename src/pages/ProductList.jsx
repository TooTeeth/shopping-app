      ...
      <div className="grid gird-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="p-4 border rounded shadow hover:shadow-lg">
          <div className="flex justify-center">
            <img src="\src\public\assets\btc.png" alt="Sample Product" />
          </div>
          <h3 className="font-semibold text-center">BTC</h3>
          <p className="text-gray-700 text-center">$97629</p>
          <div className="flex justify-center">
            <button className="mt-2 px-4 py-2 bg-blue-500 text-white roundedflex">Add to Cart</button>
          </div>
        </div>
      </div>
    </div>
